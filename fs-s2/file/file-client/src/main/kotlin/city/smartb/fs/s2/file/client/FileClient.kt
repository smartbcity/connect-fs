...
import city.smartb.fs.s2.file.domain.features.query.FileGetCommand
...
class FileClient(
    ...
    suspend fun getFile(command: List<FileGetCommand>): List<FileGetResult> = post("getFile", command)
